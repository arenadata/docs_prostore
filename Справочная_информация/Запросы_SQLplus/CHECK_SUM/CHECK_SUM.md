...
![](check_sum_по_таблице_целиком.png){:height="40%" width="50%"}
{: .figure-center}
*Ответ CHECK_SUM по логической таблице*
{: .figure-caption-center}

![](check_sum_по_логической_бд.png){:height="40%" width="50%"}
{: .figure-center}
...
1. Таблицы логической БД выстраиваются в алфавитным порядке. 
