...
маршрутизируется по-разному (см. <>).
...
*   Если для материализованного представления указана директива `FOR SYSTEM_TIME AS OF STARTED IN 
    ...
    обе дельты диапазона должны присутствовать в материализованном представлении, иначе выдается исключение.
    Подробнее о маршрутизации запросов к материализованным представлениям см. в разделе <>.
