...
Запрос позволяет проверить целостность данных [логической таблицы](../../../Обзор_понятий_компонентов_и_связей/Основные_понятия/Логическая_таблица/Логическая_таблица.md), 
...
*   если столбцы к проверке указаны, по каждой операции записи для каждой из целевых СУБД вычисляется 
