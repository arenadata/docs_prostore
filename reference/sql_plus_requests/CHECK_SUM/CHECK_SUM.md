...
### Запрос по столбцам логической таблицы {#columns_example}
...
### Запрос по логической таблице (всем столбцам таблицы) {#table_example}
...
### Расчет контрольной суммы по логической таблице {#algorithm_for_table}
...
Алгоритм расчета такой же, как [описанный в разделе CHECK_DATA](../CHECK_DATA/CHECK_DATA.md#sys_cn_checksum).
