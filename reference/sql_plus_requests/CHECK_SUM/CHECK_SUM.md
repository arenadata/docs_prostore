...
*   Контрольная сумма по логической БД рассчитывается только по данным логических таблиц и не учитывает данные материализованных 
    представлений.
...
**!!!УТОЧНИТЬ, КАК ЭТО ТЕПЕРЬ РАБОТАЕТ**
...
**!!!ПОПРАВИТЬ ПРИМЕР ПОСЛЕ УТОЧНЕНИЯ АЛГОРИТМА**
