...
этих данных. Подробнее о СУБД, из которых возможна выгрузка, см. в разделе [INSERT INTO download_external_table](../INSERT_INTO_download_external_table/INSERT_INTO_download_external_table.md).
