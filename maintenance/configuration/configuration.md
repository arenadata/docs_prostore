...
# сетевой адрес порта на хосте с ADB
    port: ${ADB_PORT:5432}
# максимальное число подключений к ADB в одном потоке; максимальное число подключений к ADB в целом по всем потокам равно произведению poolSize и executorsCount 
