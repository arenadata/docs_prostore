...
Конфигурация коннекторов задается в текстовых YAML-файлах: по одному файлу на каждый коннектор. Параметры конфигурации 
организованы в иерархическую структуру типа дерево.

В разделе представлены примеры файлов конфигурации коннекторов, где перед каждым параметром 
описано его назначение. Доступна конфигурация следующих коннекторов:
...
Коннекторы PXF и FDW не имеют конфигурационных файлов.
