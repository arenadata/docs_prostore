...
организованы в иерархическую структуру типа дерево. В разделе приведены примеры файлов конфигурации коннекторов, 
где перед каждым параметром описано его назначение.
