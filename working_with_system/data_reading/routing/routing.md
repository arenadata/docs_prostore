...
* несколько узлов (ShardSet) — запрос предназначен для нескольких узлов кластера (от 1 до всех);
...
|:-|:-
| 1. Реляционный запрос | Один узел: 1. ADG, 2. ADB, 3. ADP, 4. ADQM<br>Несколько узлов: 1. ADG, 2. ADB, 3. ADP, 4. ADQM<br>Все узлы: 1. ADB, 2. ADP, 3. ADQM, 4. ADG
| 2. Аналитический запрос | Один узел: 1. ADQM, 2. ADB, 3. ADP, 4. ADG<br>Несколько узлов: 1. ADQM, 2. ADB, 3. ADP, 4. ADG<br>Все узлы: 1. ADQM, 2. ADB, 3. ADP, 4. ADG
| 3. Запрос чтения по ключу | Один узел: 1. ADG, 2. ADB, 3. ADP, 4. ADQM<br>Несколько узлов: 1. ADG, 2. ADB, 3. ADP, 4. ADQM<br>Все узлы: 1. ADG, 2. ADB, 3. ADP, 4. ADQM
| 4. Другой запрос | Один узел: 1. ADG, 2. ADB, 3. ADP, 4. ADQM<br>Несколько узлов: 1. ADG, 2. ADB, 3. ADP, 4. ADQM<br>Все узлы: 1. ADB, 2. ADP, 3. ADQM, 4. ADG
...
### Запросы для нескольких узлов {#shard_set}
