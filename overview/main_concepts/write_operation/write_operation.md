...
На рисунке ниже показан пример с двумя операциями записи в двух логических таблицах:
`stores` и `clients`. Записи каждой таблицы добавлены одной операцией, хотя они могли бы быть добавлены 
