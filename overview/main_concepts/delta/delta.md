...
На рисунке ниже показан пример изменения данных магазина, сменившего адрес. Первоначальные данные загружены в рамках 
дельты 0, а новые данные — в рамках дельты 1.
